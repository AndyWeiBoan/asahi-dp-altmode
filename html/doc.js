...
var PAGES = [
  ...
  ['architecture.html', '架構', '角色、接線、driver 之間怎麼交互','要搞懂系統時 ★'],
  ['flow.html',         '流程', '開機／插拔／送畫面的呼叫鏈',   '要搞懂系統時 ★'],
  ['handbook.html',     '實作', '速查、build／退回、卡住怎麼查', '手放在鍵盤上時'],
  ['plan.html',         '方向', '目標、階梯、規矩',             '一個月一次'],
...
var FIGS = [
  ...
  ['07-hotplug.html', '圖 7 · 插拔事件',   '從 HPD 到 CD321x IRQ、kernel 與 mux','流程 §2'],
  ['05-boot.html',    '圖 5 · 開機鏈',     'iBoot → m1n1 → U-Boot → GRUB → Linux','流程 §1']
];
